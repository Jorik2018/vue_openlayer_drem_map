...
Vue.component('v-panel', {
    ...
    template: '<div class="ui-panel"><div v-if="header" class="ui-panel-titlebar v-widget-header ui-helper-clearfix ui-corner-all"><span class="ui-panel-title">{{header}}</span></div><div class="ui-dialog-content ui-widget-content"><slot></slot></div></div>'
});
